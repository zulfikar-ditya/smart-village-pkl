...
<div class="container" id="dashboard">
    <div class="row justify-content-center">
        ...
        <div class="col-md-3 bg-rose m-3 shadow rounded-1 p-5 text-white text-center">
            <div class="card">
        ...
        <div class="col-md-3 bg-lime m-3 shadow rounded-1 p-5 text-white text-center">
            <div class="card">
        ...
        <div class="col-md-3 bg-indigo m-3 shadow rounded-1 p-5 text-white text-center">
            <div class="card">
