...
--
-- Host: 127.0.0.1
-- Generation Time: May 11, 2019 at 04:10 AM
...
INSERT INTO `lapor_aduan` (`id`, `foto`, `deskripsi`, `user_id`, `pembangunan_id`, `status`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `mitra` (`id`, `nama_mitra`, `alamat`, `no_telp`, `email`, `user_id`) VALUES
...
INSERT INTO `pembangunan` (`id`, `nama_pembangunan`, `foto`, `anggaran`, `tgl_mulai`, `tgl_selesai`, `longitude`, `latitude`, `keterangan`, `prosentase`, `sumber_dana_pembangunan_id`, `kategori_pembangunan_id`, `status_pembangunan_id`, `user_id`, `mitra_id`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `request_pembangunan` (`id`, `judul`, `deskripsi`, `user_id`, `kategori_pembangunan_id`, `status`, `created_at`, `updated_at`) VALUES
...
(1, 1, 'Administrator', 'admin', 'dd94709528bb1c83d08f3088d4043f4742891f4f', 'Y1j-gM3JtyEmJagdH2sogdv4FFKvy7Fc', '', 'YWRtaW46NDMzYTliN2IwZTlhOGJmZjhiNjhhODEyYmU0ZmM3ZTRkNzBhM2Q0NA==', 'admin@gmail.com', 'f0315bbaa88081dfc8071971d5cc315d.jpg', '2019-04-30 14:08:21', 1, '2017-10-23 14:26:39', '2019-04-30 14:08:21'),
...
--
ALTER TABLE `lapor_aduan`
  ADD CONSTRAINT `lapor_aduan_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `lapor_aduan_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `mitra`
  ADD CONSTRAINT `fk_mitrauser` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `pembangunan`
  ...
  ADD CONSTRAINT `pembangunan_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  ADD CONSTRAINT `pembangunan_ibfk_3` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  ADD CONSTRAINT `pembangunan_ibfk_5` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `request_pembangunan`
  ADD CONSTRAINT `request_pembangunan_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `user`
  ADD CONSTRAINT `user_fk11` FOREIGN KEY (`penduduk_id`) REFERENCES `penduduk` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
